...
class ContagionScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const SectionHeader(title: "CONTAGION MAP", subtitle: "Visualizing threat propagation and distribution networks"),
            Expanded(
              child: Center(
                child: Column(
